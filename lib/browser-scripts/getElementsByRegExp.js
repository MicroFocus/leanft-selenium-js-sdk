...
var expr = arguments[3];
var flags = arguments[4] || "";
var candidateFilter = (tagsFilter && tagsFilter.toLowerCase() === "a") ? findLinks : function() { return true; };

var candidates = context.getElementsByTagName("*");
candidates = Array.prototype.filter.call(candidates, candidateFilter);
expr = propName === "tagName" ? (expr || "").toUpperCase() : expr;

return findElements(candidates, propName, expr, flags);